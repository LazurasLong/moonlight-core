...
You'll find the markdown source, broke down into chapters, in the [text/markdown](/text/markdown) folder. The [text](text) folder also includes the system in PDF, Latex, and HTML format.
