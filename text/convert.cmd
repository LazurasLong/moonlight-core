...
pandoc %files% -S --toc -f markdown -c "style.css" -t html -s -o "html\moonlight.html"
...
for %%i in (markdown\*.md) do pandoc "markdown\%%~ni.md" -S --toc -f markdown -c "style.css" -t html -s -o "html\%%~ni.html"
