...
pandoc ../source/*.md -V fontsize=12pt -V geometry:margin=3cm --toc -t latex -s -o "../text/pdf/moonlight.pdf"
...
for file in ../source/*.md; do
    ...
    pandoc "$file" -V fontsize=12pt -V geometry:margin=3cm -t latex -s -o "../text/pdf/${filename%.*}.pdf"
done